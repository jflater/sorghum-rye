...
soil_table_data <- soil_with_letters %>%
  ...
  dplyr::select(year, date, treatment, ammonium, nitrate, total_n)
...
source_variation <- tibble(
  ...
  dplyr::select(year_display, date_display, treatment, ammonium, nitrate, total_n)
...
table2_complete <- bind_rows(
  soil_table_formatted %>% 
    dplyr::select(year_display, date_display, treatment, ammonium, nitrate, total_n, is_new_date),
  separator_row,
