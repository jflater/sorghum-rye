...
pdplot <- rain_plot_v2 | gdd_plot_v2 +
  plot_annotation(
    theme = theme_publication() + theme(
      legend.position = "top",
      legend.justification = "center",  # Changed to center
...
# Figure 1: Soil Moisture and Temperature
```{r}
#| label: fig-soil-moisture-temp
#| fig-cap: "Daily soil moisture and temperature over the study period"
#| fig-width: 10
#| fig-height: 8
...
soil_4panel <- (p1 | p3) / (p2 | p4) +
  plot_annotation(
    theme = theme_publication() + theme(
      legend.position = "top",  # Changed from "bottom" to "top"
      legend.justification = "center",  # Center justified
      legend.direction = "horizontal"
    )
  )

# Keep the combined plot simple
six_panel_plot <- pdplot / soil_4panel +
  plot_layout(heights = c(1, 1))
# Save the plots
ggsave("figures/soil_4panel.png", soil_4panel, width = 10, height = 8, dpi = 300)
